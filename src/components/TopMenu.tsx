    ...
    <>
      <div className="sticky z-10 top-0 h-16  bg-white lg:py-2.5">
        <div className="px-6 flex items-center justify-between space-x-4">
          <h5
            /* hidden */ className="text-2xl text-gray-600 font-medium lg:block"
          >
            Dashboard
          </h5>
          ...
          <div className="flex space-x-2">
            ...
            <Link
              href={"/dashboard/cart"}
              className="flex items-center justify-center w-10 h-10 rounded-xl bg-gray-100 focus:bg-gray-100 active:bg-gray-200"
            >
              {totalItems > 0 && (
